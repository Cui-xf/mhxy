...
class GameScreen(
    ...
    // 门
    private val doorW = 64f;  private val doorH = 96f
    private val doorX = 268f; private val doorY = mapH - doorH - 20f
    ...
    override fun render(delta: Float) {
        ...
        hud.renderBars()     // HUD 血条/蓝条（内部自己 begin/end）
        ...
        if (showDemo) {
            ...
            demoFont.draw(batch, "1.静态图->playerRegion  2.帧动画->走路切换帧  3.图集切片->右下角图标", 10f, hudH + mapH - 28f)
        }
        demoFont.draw(batch, "WASD移动  M地图  ESC返回主菜单  Tab${if (showDemo) "隐藏" else "显示"}说明", 10f, hudH + 14f)
