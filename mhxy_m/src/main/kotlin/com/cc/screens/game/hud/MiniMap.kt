...
import com.cc.screens.game.world.Npc
import com.cc.screens.game.world.Player
import com.cc.screens.game.world.ScreenMap
...
class MiniMap(
    ...
    override fun render(
        ...
        // 画小地图底图
        batch.begin()
        batch.draw(miniMapTex, miniLeft, AbstractScreen.VIRTUAL_H - miniTop - miniH)
        batch.end()
        ...
        sr.drawRect(
            Color.RED,
            miniLeft + player.roleMapX / miniScale,
            miniTop + player.roleMapY / miniScale,
            2f,
            2f
        )
        ...
        batch.drawString(
            ...
            "${(player.roleMapX / 16).toInt()},${(player.roleMapY / 16).toInt()}",
            Color.WHITE,
            miniLeft,
            miniTop + miniH + 2f,
            Align.LEFT_TOP
