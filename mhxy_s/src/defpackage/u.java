    ...
    public final int a(int i, int i2) {
        if (b(i, i2)) {
            ...
            if (this.e != null) {
                ...
                if (i > this.f + ((this.h - iStringWidth) / 2)) {
                    if (i < ((iStringWidth + this.h) / 2) + this.f && i2 > this.f && i2 < this.g + this.i) {
                        return 1073741824;
                    }
                }
            }
            if (this.j != null && i > ((this.f + this.h) - t.i.stringWidth(this.j)) - 5 && i < this.f + this.h && i2 > this.g && i2 < this.g + this.i) {
                return 536870912;
            }
        }
        return 0;
