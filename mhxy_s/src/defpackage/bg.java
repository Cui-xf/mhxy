...
public final class bg implements CommandListener {
    ...
    public final void a(Display display, String str, String str2, int i2) {
        ...
        if (i2 == 0) {
            ...
            this.o = new TextField(str3, str2, 12, 0);
        } else if (i2 == 3) {
        ...
        switch (this.a) {
            ...
            case 6:
                if (!label.equals("提交")) {
                    ...
                    int i3 = Integer.parseInt(X[this.U.getSelectedIndex()].trim());
                    if (!z.a(string9)) {
                        if (!bj.b(string9)) {
                            a("充值卡序号有误！", (byte) 2);
                            break;
            ...
            case 9:
                if (!label.equals("提交")) {
                    ...
                    int i4 = this.Z.getSelectedIndex() == 0 ? 1 : this.Z.getSelectedIndex() == 1 ? 2 : 3;
                    String string14 = this.aa.getString();
                    String string15 = this.ab.getString();
                    if (!z.a(string14)) {
                        if (i4 == 1 && !z.c(string14)) {
                            a("用户名只能为数字和字母的组合形式", (byte) 2);
                            break;
                        } else if (i4 == 1 && !z.a(string14, 4, 10)) {
                            a("用户名为4-10 的数字和字母的组合", (byte) 2);
                            break;
                        } else if (i4 == 2 && !z.e(string14)) {
                            a("手机号不合符规范，应为11位数字", (byte) 2);
                            break;
                        } else if (i4 == 3 && !z.d(string14)) {
                            a("ID 应为数字", (byte) 2);
                            break;
