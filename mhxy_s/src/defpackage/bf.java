...
public final class bf extends cf {
        ...
        while (true) {
            ...
            if (j19 >= 0 && j19 <= 36000000) {
                ...
                if (j23 == 0) {
                    ...
                    long j26 = (2 * j24) - j25;
                    long jA2 = 255 * a(j26, j25, 33333 + j22);
                    long jA3 = 255 * a(j26, j25, j22);
                    jA = a(j26, j25, j22 - 33333) * 255;
                    j7 = jA3;
                    j8 = jA2;
                }
                iArr[i2] = (((((int) (jA / 100000)) & 255) | ((((int) (j7 / 100000)) & 255) << 8) | ((((int) (j8 / 100000)) & 255) << 16) | (-16777216)) & 16777215) | (((int) (j21 / 100000)) << 24);
            } else {
    ...
    public final void a(byte[][] bArr, boolean z) throws IOException {
        ...
        byteArrayOutputStream2.write(ai.b);
        int i2 = 1;
        while (i2 < bArr.length) {
            if (bArr[i2] != null && bArr[i2].length > 4) {
                ...
                byteArrayOutputStream2.write(a(ai.a[i2 > 4 ? 4 : i2], bArr[i2]));
            }
            i2++;
        }
        byteArrayOutputStream2.write(ai.c);
