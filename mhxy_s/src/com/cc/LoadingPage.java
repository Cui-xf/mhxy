...
public final class LoadingPage {
   ...
   public static void a(Graphics var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if (GlobalConfig.pingTaiBiaoShi != 2) {
   ...
   public static void a(Graphics var0, int var1, int var2, int var3, int var4, TextRender var5, String[] var6, String[] var7) {
      ...
      if (var5 != null) {
         ...
         for(int var10 = e; var10 < var1; ++var10) {
            var5.a(var0, 10, var2 + 12 + (var10 - e) * GlobalConfig.font2_h, var10, 20);
         }
   ...
   public static void a(Graphics var0, String var1, String[] var2) {
      if (var1 != null) {
         ...
         if (h >= 0) {
            if (h == 0) {
               I = ((H = a(var1, GlobalConfig.font2, GlobalConfig.defaultWidth - 10, "\t")).length + 1) * GlobalConfig.font2_h + 20;
   ...
   public static void b(Graphics graphics, String str, int i2, int i3, int i4, int i5) {
      ...
      if (l >= 15) {
         ...
         String[] strArrA = a(string.trim(), GlobalConfig.font2, i6, "\t");
         int iMax = 0;
         for (int i1 = 0; i1 < strArrA.length; i1++) {
         ...
         if (i5 == 1) {
            ...
            Y = (GlobalConfig.font2_h * V.a()) + 8;
         } else if (i5 == 2) {
            W = a(str.trim(), GlobalConfig.font2, X - 8, "\t");
   ...
   public static void a(Graphics var0, String var1, String var2, int var3, int var4, int var5) {
      if (l >= 15) {
         if (l == 15) {
            ...
            Y = GlobalConfig.font2_h * (ae == null ? 1 : ae.a() + 1) + 8;
   ...
   public static void a(Graphics var0, String var1, int var2, boolean var3) {
      ...
      if (var2 > 0) {
         a(var0, "" + var2, var5 + 70, var6 + 6 + GlobalConfig.font2_h + 12, 17, 16711639);
      }
