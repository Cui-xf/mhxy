...
public final class o_1 {
    ...
    public o_1(GameSceneController var1, MainCanvas var2, PngUtil var3) {
    ...
    public final void a(int var1, short var2, int var3) {
        ...
        this.j.textPanel.setFWBText(GlobalStatus.a(this.j.shareSb), GlobalConfig.font2, (byte) 1);
        ...
        var1 = this.j.mixedUi.X + 10 + GlobalConfig.font2.stringWidth("宝石:");
        int var2_t = this.j.mixedUi.Y + 37;
        if (this.l != null) {
        ...
        if (this.i.sceneSubState == 0) {
            ...
            if (var1 != 268435456 && var1 != 1073741824 && var1 != 517) {
                ...
                if (GlobalStatus.kr[this.b] == 0) {
                    LoadingPage.a(this.j.mixedUi.X + 10 + GlobalConfig.font2.stringWidth("宝石:") + 12 + this.b * 17, this.j.mixedUi.Y + 45, new String[]{"镶嵌", "全部挖出"}, false);
                    this.a = this.b;
                    this.i.sceneSubState = 1;
                    return;
                }

                LoadingPage.a(this.j.mixedUi.X + 10 + GlobalConfig.font2.stringWidth("宝石:") + 12 + this.b * 17, this.j.mixedUi.Y + 45, new String[]{"查看", "挖出", "全部挖出"}, false);
                this.a = this.b;
            ...
            if (var1 != 268435456 && var1 != 1073741824 && var1 != 517) {
                ...
                if (LoadingPage.o == 1) {
                    e = 1;
                    byte[] var6;
                    if ((var6 = NetPayloadBuilder.a((short) 4687, GlobalStatus.ko, (byte) 2, this.c == 13 ? GlobalStatus.jG : 0, 0, (byte) 0, "", GlobalStatus.roleId_2)) == null) {
            ...
            if (var1 != 268435456 && var1 != 1073741824 && var1 != 517) {
                ...
                if (this.c == 13) {
                    byte[] var7;
                    if ((var7 = NetPayloadBuilder.a((short) 4687, GlobalStatus.ko, (byte) 0, GlobalStatus.jG, 0, this.b, "", GlobalStatus.roleId_2)) == null) {
                        this.j.showTips("获取上传指令数据错误!");
                        return;
                    }
                    ...
                    byte[] var8;
                    if ((var8 = NetPayloadBuilder.g((short) 4647, GlobalStatus.roleId_2, GlobalStatus.ko, (byte) this.b)) == null) {
                        this.j.showTips("获取上传指令数据错误!");
                        return;
                    }
                ...
                if (this.c == 13) {
                    byte[] var9;
                    if ((var9 = NetPayloadBuilder.a((short) 4687, GlobalStatus.ko, (byte) 1, GlobalStatus.jG, 0, this.b, "", GlobalStatus.roleId_2)) == null) {
                        this.j.showTips("获取上传指令数据错误!");
                        return;
                    }
                    ...
                    byte[] var10;
                    if ((var10 = NetPayloadBuilder.f((short) 4646, GlobalStatus.roleId_2, GlobalStatus.ko, (byte) this.b)) == null) {
                        this.j.showTips("获取上传指令数据错误!");
                        return;
                    }
                ...
                e = 1;
                byte[] var11;
                if ((var11 = NetPayloadBuilder.a((short) 4687, GlobalStatus.ko, (byte) 2, this.c == 13 ? GlobalStatus.jG : 0, 0, (byte) 0, "", GlobalStatus.roleId_2)) == null) {
                    this.j.showTips("获取上传指令数据错误!");
                    return;
                }
    ...
    public final void a(Graphics var1) {
        ...
        if (GlobalStatus.kr != null) {
            this.i.a(var1, this.j.mixedUi.X + 10 + GlobalConfig.font2.stringWidth("宝石:"), this.j.mixedUi.Y + 37, 17, 17, GlobalStatus.kr.length, 1);

            for (byte var2 = 0; var2 < GlobalStatus.kr.length; ++var2) {
                if (GlobalStatus.kr[var2] <= -1) {
                    LoadingPage.fillRect(var1, 125269879, 207, this.j.mixedUi.X + 10 + GlobalConfig.font2.stringWidth("宝石:") + 2 + var2 * 17, this.j.mixedUi.Y + 39, 17, 17);
                }
            ...
            if (this.c == 4 && this.d == 0 || this.c == 5 || this.c == 13) {
                ...
                var1.drawRect(this.j.mixedUi.X + 10 + GlobalConfig.font2.stringWidth("宝石:") + 2 + this.b * 17, this.j.mixedUi.Y + 39, 17, 17);
            }
        }

        if (this.i.sceneSubState == 1 || this.i.sceneSubState == 2) {
            LoadingPage.c(var1);
        }
    ...
    public final void a() {
        this.i.sceneSubState = 0;
        this.j.mixedUi.clean();
        this.j.mixedUi.setTitle("装备打孔");
        this.j.gunDongListUi.setValue((Image[]) null, GlobalStatus.kn, (String[]) null, (String[]) null);
        this.j.bottomUi.a("确定");
        if (GlobalStatus.km != null && GlobalStatus.km.length > 0) {
            this.j.textPanel.setFWBText(GlobalStatus.i(this.j.shareSb, this.j.gunDongListUi.g()), GlobalConfig.font2, (byte) 2);
        } else {
            this.j.textPanel.setFWBText((String) null, GlobalConfig.font2, (byte) 2);
        }

        this.j.textPanel.setShuRuMoShi((byte) 1);
        this.j.mixedUi.addChild((BaseUi) this.j.gunDongListUi);
        this.j.mixedUi.addChild((BaseUi) this.j.textPanel);
        if (GlobalConfig.defaultHigh > 220) {
            this.j.mixedUi.addChild((BaseUi) this.j.bottomUi);
        }
    ...
    public final void c() {
        this.j.mixedUi.clean();
        this.j.mixedUi.setTitle(m);
        TextPanel var10000 = this.j.textPanel;
        StringBuffer var1;
        ...
        var10000.setFWBText(var1.toString(), GlobalConfig.font2, (byte) 1);
        this.j.bottomUi.a("确定");
        this.j.mixedUi.addChild((BaseUi) this.j.textPanel);
        if (GlobalConfig.defaultHigh > 220) {
            this.j.mixedUi.addChild((BaseUi) this.j.bottomUi);
    ...
    public final void a(boolean var1) {
        ...
        if (this.G != null) {
            for (int var3 = 0; var3 < this.G.length; ++var3) {
                if (var3 == 0) {
                    var1_t = this.j.mixedUi.X + this.j.mixedUi.W / 4 - 8;
                    var2 = this.j.mixedUi.Y + 32 + this.H - 4 - 17;
                } else if (var3 == 1) {
    ...
    public final void e(int var1) {
        if (this.i.sceneSubState == 0) {
            ...
            if (var1 != 268435456 && var1 != 1073741824) {
                ...
                if (this.f != 0) {
                    if (this.f == 1) {
                        var4 = NetPayloadBuilder.a((short) 4688, g, x, (byte) 2, h, GlobalStatus.jG, B, GlobalStatus.roleId_2);
                    }
                } else {
                    var4 = null;
                    if (this.O != null) {
                    ...
                    var4 = NetPayloadBuilder.a((short) 4688, g, x, (byte) 3, h, GlobalStatus.jG, var4, GlobalStatus.roleId_2);
                }
                ...
                if (this.i.aw && !this.N) {
                    ...
                    GlobalStatus.b((int) GameSceneController.l(this.i.aq));
                } else {
                    var1 = g;
                    Object var9 = null;
                    int var11 = 0;
    ...
    public final void d(Graphics var1) {
        int var2 = this.j.mixedUi.Y + 32 + this.H + this.I + 4;
        int var3 = (this.j.mixedUi.W - 21 - 31) / 2;
        int var4;
        ...
        if (this.G != null) {
            for (int var6 = 0; var6 < this.G.length; ++var6) {
                ...
                if (var6 < 2) {
                    var10000 = this.k;
                    var10001 = var1;
                    var10002 = GameSceneController.goods;
                } else {
