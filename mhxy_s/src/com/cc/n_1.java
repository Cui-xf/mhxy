...
public final class n_1 extends al {
   ...
   public final void a(int var1, int var2, int var3, int var4) {
      ...
      for(int var5 = 0; var5 < this.c.length; ++var5) {
         this.h += 10 + t_1.i.stringWidth(this.c[var5]);
      }
   ...
   private int a() {
      ...
      for(byte var2 = this.d; var2 <= this.a; ++var2) {
         var1 += 10 + t_1.i.stringWidth(this.c[var2]);
      }
   ...
   public final void a(Graphics var1) {
      int var2 = 0;
      int var3 = 10 + t_1.i.stringWidth(this.c[this.d]);
      this.k = 0;
      ...
      for(int var9 = 0; var9 < var12.length; ++var9) {
         if (var9 >= var15 && var9 < var15 + var11.k) {
            int var10 = 10 + t_1.i.stringWidth(var11.c[var9]);
            var11.j[var9][0] = var6 + var8;
            var11.j[var9][1] = var7;
            var11.j[var9][2] = var10 - 2;
            var11.j[var9][3] = t_1.j - 2;
            var8 += 10 + t_1.i.stringWidth(var11.c[var9]);
         } else {
            var11.j[var9][0] = -1;
            var11.j[var9][1] = -1;
            var11.j[var9][2] = -1;
