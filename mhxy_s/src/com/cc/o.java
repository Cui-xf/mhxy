...
public final class o {
   ...
   public final void a(int var1, short var2, int var3) {
      ...
      this.j.aq.a(false);
      this.j.aq.a(30);
      this.j.at.a(bt_1.a(this.j.l), t.i, (byte)1);
      this.j.au.a("确定");
      ...
      var1 = this.j.aq.a + 10 + t.i.stringWidth("宝石:");
      var2 = this.j.aq.b + 37;
      if (this.l != null) {
   ...
   public final void a(Graphics var1) {
      if (this.j.aq != null) {
         this.j.aq.a(30);
         this.j.aq.a(var1);
         ca.a(var1, this.j.aq.a + 5, this.j.aq.b + 32, this.j.aq.c - 11, 30, 1);
         ca.a(var1, (String)"宝石", (int)(this.j.aq.a + 10), this.j.aq.b + 35 + t.a(25), 20, 16776960, 0);
      }

      if (bt_1.kr != null) {
         this.i.a(var1, this.j.aq.a + 10 + t.i.stringWidth("宝石:"), this.j.aq.b + 37, 17, 17, bt_1.kr.length, 1);

         for(byte var2 = 0; var2 < bt_1.kr.length; ++var2) {
            if (bt_1.kr[var2] <= -1) {
               ca.a(var1, 125269879, 207, this.j.aq.a + 10 + t.i.stringWidth("宝石:") + 2 + var2 * 17, this.j.aq.b + 39, 17, 17);
            }

            if (bt_1.kr[var2] > 0) {
               a_MainCanvas.f.a(var1, ao_1.b(bt_1.kr[var2]), (int[])null, (aj)null, 0, 0, this.j.aq.a + 10 + t.i.stringWidth("宝石:") + 2 + var2 * 17, this.j.aq.b + 39, 0, 0);
            }
         }

         if (this.c == 4 && this.d == 0 || this.c == 5 || this.c == 13) {
            var1.setColor(16776960);
            var1.drawRect(this.j.aq.a + 10 + t.i.stringWidth("宝石:") + 2 + this.b * 17, this.j.aq.b + 39, 17, 17);
         }
      }
   ...
   public final void a() {
      ...
      if (bt_1.km != null && bt_1.km.length > 0) {
         this.j.at.a(bt_1.i(this.j.l, this.j.ar.g()), t.i, (byte)2);
      } else {
   ...
   public final void c() {
      ...
      var10000.a(var1.toString(), t.i, (byte)1);
      this.j.au.a("确定");
      this.j.aq.a((al)this.j.at);
      if (t.c > 220) {
         this.j.aq.a((al)this.j.au);
   ...
   public final void b(DataInputStream var1) {
      g = var1.readInt();
      v = var1.readShort();
      w = var1.readUTF();
      x = var1.readLong();
   ...
   public final void a(boolean var1) {
      ...
      this.j.aq.a("装备洗炼");
      this.j.aq.a(false);
      this.J = Math.max(ao_1.x.c, t.j) * 7 + 16;
      this.H = ao_1.x.c + t.j + 8;
      ...
      if (this.G != null) {
         for(int var3 = 0; var3 < this.G.length; ++var3) {
            if (var3 == 0) {
               var1 = this.j.aq.a + this.j.aq.c / 4 - 8;
               var2 = this.j.aq.b + 32 + this.H - 4 - 17;
            } else if (var3 == 1) {
               var1 = this.j.aq.a + this.j.aq.c / 4 * 3 - 8;
            } else if (var3 > 1) {
               var1 = this.j.aq.a + (this.j.aq.c - 17) / 2;
               var2 = this.j.aq.b + 32 + this.H + this.I + 4 + 2 + (var3 - 1) * (Math.max(ao_1.x.c, t.j) + 1);
            }

            boolean var10001 = true;
            this.a(var3, var1, var2, 17, 17);
         }
      }
   ...
   public final void d(Graphics var1) {
      ...
      if (this.j.aq != null) {
         this.j.aq.a(var1);
         ca.a(var1, this.j.aq.a + 5, this.j.aq.b + 32, this.j.aq.c - 11, this.H, 1);
         ca.a(var1, this.j.aq.a + 5, this.j.aq.b + 32 + this.H + 1, this.j.aq.c - 11, this.I - 2, 1);
         ca.a(var1, var4, var2, var3, this.J - 9, 1);
         ca.a(var1, var5, var2, var3, this.J - 9, 1);
      }
      ...
      ca.d(var1, this.G[this.f][0], this.G[this.f][1], 17, 17);
      if (this.i.l == 0) {
         if (this.F != null || this.F != "") {
            if (this.f == 1) {
               ca.b(var1, this.F, this.G[1][0] + 8, this.G[1][1] + 8, t.c - 5, 1);
               return;
            }

            if (this.f == 0) {
               ca.b(var1, this.F, this.G[0][0] + 8, this.G[0][1] + 8, t.c - 5, 1);
               return;
            }
         }
      } else if (this.i.l == 1) {
