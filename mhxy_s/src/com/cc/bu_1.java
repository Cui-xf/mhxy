...
public final class bu_1 {
   ...
   public final void d() {
      ...
      try {
         ...
         if ((var18 = this.getClass().getResourceAsStream(this.b + this.a + ".rpg")) == null) {
            ...
            (var19 = new DataInputStream(var18)).read(ai.d);
            var10000 = var19;
         }
   ...
   private void a(aa var1, DataInputStream var2, short var3, short var4, short var5) {
   ...
   private void b(aa var1, DataInputStream var2, short var3, short var4, short var5) {
      bf_1 var6;
   ...
   private static byte[][] a(DataInputStream var0, int var1) {
      var0.skipBytes(0);
      var0.readShort();
      var0.readByte();
   ...
   private bc_1 c(short var1, short var2, short var3, short var4) {
      Object var5 = null;
      var5 = null;

      for(int var6 = 0; var6 < this.c.size(); ++var6) {
         cf var8;
         if ((var8 = (cf)this.c.elementAt(var6)).o == 2 && var8.p != null && var8.p.b == var1 && (var8 = var8).a == var2 && var8.b == var3 && var8.c == var4) {
            return var8;
         }
      }
   ...
   private bf_1 d(short var1, short var2, short var3, short var4) {
      Object var5 = null;
      var5 = null;

      for(int var6 = 0; var6 < this.c.size(); ++var6) {
         cf var8;
         if ((var8 = (cf)this.c.elementAt(var6)).o == 0 && var8.p != null && var8.p.b == var1 && (var8 = var8).e == var2 && var8.f == var3 && var8.g == var4) {
            return var8;
         }
      }
