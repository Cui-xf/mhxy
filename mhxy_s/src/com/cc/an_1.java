...
public final class an_1 extends al {
      ...
      label268: {
         ...
         if (this.r) {
            ...
            if (this.m != null && !this.m.equals("")) {
               this.n = ca.a(this.m, this.l, this.d - 8 - a_MainCanvas.C.b, this.u);
               this.v = ca.a(this.n[0]) != -1 ? ca.a(this.n[0]) : 2176196;
               if (this.v != 2176196) {
   ...
   public final void a(Graphics var1) {
      ...
      if (this.j) {
         ca.a(var1, this.b, this.c, this.d, this.e, 1);
         if (this.f) {
            ca.a(var1);
         }
      }
      ...
      if (!this.r && this.n != null) {
         for(int var3 = this.a; var3 < this.n.length && var3 < this.a + this.p; ++var3) {
            ...
            if (var3 == this.h && this.g == 0) {
               ca.a(var1, this.n[var3], this.b + 4, this.c + 4 + (var3 - this.a) * this.y, 20, 13500379);
            } else {
               ca.a(var1, this.n[var3], this.b + 4, this.c + 4 + (var3 - this.a) * this.y, 20, this.v);
            }
         }

         if (this.q > 0) {
            ca.a(var1, this.b + this.d - 2 - a_MainCanvas.C.b, this.c + 3, this.e - 5, this.q, this.a, this.o, this.p);
