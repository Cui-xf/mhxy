...
public final class bz_1 {
   ...
   public static w a(byte var0, byte var1, String var2) {
      try {
         ...
         var4.writeUTF(t_1.F);
         var4.writeInt(-1);
         var4.writeByte(t_1.r);
         var4.writeByte(t_1.s);
         var4.writeByte(t_1.u);
         var4.writeInt((int)Runtime.getRuntime().totalMemory());
         var4.writeByte(var1);
         var4.writeUTF(var2);
         var4.writeByte(-81);
         return new w((short)6400, var3.toByteArray());
   ...
   public static byte[] a(byte var0, int var1, int var2, int var3) {
      try {
         ...
         (new StringBuffer()).append("代理服务器包头: ").append(1).append("|").append(var1).append("|").append(0).append("|").append(0).toString();
         var6.writeInt(var1);
         var6.writeInt(0);
         var6.writeInt(0);
   ...
   public static byte[] a(short var0, String var1, String var2, String var3) {
      try {
         ByteArrayOutputStream var4 = new ByteArrayOutputStream();
         DataOutputStream var5;
         (var5 = new DataOutputStream(var4)).writeByte(-82);
         var5.writeShort(var0);
         var5.writeByte(t_1.r);
         var5.writeByte(t_1.s);
         var5.writeUTF(var1);
         var5.writeUTF(var2);
         var5.writeUTF(var3);
         var5.writeByte(-81);
   ...
   public static byte[] a(short var0, String var1, byte var2, short var3, short var4) {
      try {
         ...
         var5.writeUTF(bt_1.b);
         var5.writeUTF(bt_1.d);
         var5.writeUTF(var1);
         var5.writeByte(-81);
   ...
   public static byte[] a(short var0, String var1) {
      try {
         ...
         var2.writeUTF(bt_1.b);
         var2.writeUTF(bt_1.d);
         var2.writeUTF(var1);
         var2.writeByte(-81);
         return var4.toByteArray();
   ...
   public static byte[] b(short var0, String var1) {
      try {
         ...
         var2.writeShort(t_1.b);
         var2.writeShort(t_1.c);
         var2.writeUTF(bt_1.b);
         var2.writeUTF(bt_1.d);
         var2.writeUTF(var1);
         var2.writeByte(-81);
   ...
   public static byte[] c(short var0, String var1) {
      try {
         ...
         var3.writeUTF(bt_1.b);
         var3.writeUTF(bt_1.d);
         var3.writeUTF(var1);
         var3.writeByte(-81);
   ...
   public static byte[] a(short var0, String var1, int var2, int var3, short var4, long var5) {
      try {
         ...
         var7.writeLong(var5);
         var7.writeUTF(bt_1.b);
         var7.writeUTF(bt_1.d);
         var7.writeUTF(var1);
         var7.writeByte(-81);
   ...
   public static byte[] a(short var0, String var1, int var2, int var3, long var4) {
      try {
         ...
         var8.writeByte(1);
         var8.writeLong(var4);
         var8.writeUTF(bt_1.b);
         var8.writeUTF(bt_1.d);
         var8.writeUTF(var1);
         var8.writeByte(-81);
         return var7.toByteArray();
      } catch (IOException var6) {
   ...
   public static byte[] b(short var0, String var1, int var2, int var3, long var4) {
      try {
         ...
         var6.writeLong(var4);
         var6.writeUTF(bt_1.b);
         var6.writeUTF(bt_1.d);
         var6.writeUTF(var1);
         var6.writeByte(-81);
   ...
   public static byte[] a(short var0, String var1, long var2, int var4, short var5, byte var6, int var7, byte var8, byte var9, short var10, int var11, byte var12, byte var13) {
      try {
         ...
         var14.writeUTF(bt_1.b);
         var14.writeUTF(bt_1.d);
         var14.writeUTF(var1);
         var14.writeByte(-81);
   ...
   public static byte[] g(short var0, String var1, String var2) {
      try {
         ...
         var3.writeByte(t_1.r);
         var3.writeByte(t_1.s);
         var3.writeUTF(var1);
         var3.writeUTF(var2);
         var3.writeByte(-81);
         return var5.toByteArray();
   ...
   public static byte[] a(short var0, int var1, long var2, byte var4, byte var5, int var6, byte[] var7, String var8) {
      try {
         ...
         var9.writeUTF(bt_1.b);
         var9.writeUTF(bt_1.d);
         var9.writeUTF(var8);
         var9.writeByte(-81);
   ...
   public static byte[] a(short var0, int var1, long var2, byte var4, int[] var5, byte[] var6, int var7, byte var8, String var9) {
      try {
         ...
         var10.writeUTF(bt_1.b);
         var10.writeUTF(bt_1.d);
         var10.writeUTF(var9);
         var10.writeByte(-81);
   ...
   public static byte[] a(short var0, byte var1, String var2, String var3, boolean var4, String var5, String var6, int var7, String var8) {
      try {
         ...
         var11.writeByte(t_1.r);
         var11.writeByte(t_1.s);
         var11.writeByte(0);
         var11.writeInt(1);
         var11.writeInt(1);
         var11.writeUTF(var2);
   ...
   public static byte[] D(short var0, String var1) {
      try {
         ...
         var2.writeUTF(bt_1.d);
         var2.writeUTF(var1);
         var2.writeShort(bt_1.eE[0]);
         var2.writeShort(bt_1.eE[1]);
         var2.writeShort(bt_1.eE[2]);
         var2.writeShort(bt_1.eF);
         if (bt_1.eG != null && bt_1.eG.length > 0 && bt_1.eG.length < 10) {
            for(int var5 = 0; var5 < bt_1.eG.length; ++var5) {
               var2.writeByte(bt_1.eG[var5]);
            }
         }

         if (bt_1.eH != null && bt_1.eH.length > 0 && bt_1.eH.length < 10) {
            for(int var6 = 0; var6 < bt_1.eH.length; ++var6) {
               var2.writeShort(bt_1.eH[var6]);
            }
         }

         if (bt_1.eI != null && bt_1.eI.length > 0 && bt_1.eI.length < 10) {
            for(int var7 = 0; var7 < bt_1.eI.length; ++var7) {
               var2.writeInt(bt_1.eI[var7]);
            }
         }

         if (bt_1.eJ != null && bt_1.eJ.length > 0 && bt_1.eJ.length < 10) {
            for(int var8 = 0; var8 < bt_1.eJ.length; ++var8) {
               var2.writeUTF(bt_1.eJ[var8]);
            }
         }
   ...
   public static byte[] c(short var0, byte var1, String var2) {
      try {
         ...
         var3.writeUTF(var2);
         var3.writeByte(var1);
         var3.writeShort(bt_1.eM[0]);
         var3.writeShort(bt_1.eM[1]);
         var3.writeShort(bt_1.eM[2]);
         var3.writeShort(bt_1.eN);
         if (bt_1.eO != null && bt_1.eO.length > 0 && bt_1.eO.length < 10) {
            for(int var6 = 0; var6 < bt_1.eO.length; ++var6) {
               var3.writeByte(bt_1.eO[var6]);
            }
         }

         if (bt_1.eP != null && bt_1.eP.length > 0 && bt_1.eP.length < 10) {
            for(int var7 = 0; var7 < bt_1.eP.length; ++var7) {
               var3.writeShort(bt_1.eP[var7]);
            }
         }

         if (bt_1.eQ != null && bt_1.eQ.length > 0 && bt_1.eQ.length < 10) {
            for(int var8 = 0; var8 < bt_1.eQ.length; ++var8) {
               var3.writeInt(bt_1.eQ[var8]);
            }
         }

         if (bt_1.eR != null && bt_1.eR.length > 0 && bt_1.eR.length < 10) {
            for(int var9 = 0; var9 < bt_1.eR.length; ++var9) {
               var3.writeUTF(bt_1.eR[var9]);
            }
         }
   ...
   public static byte[] b(short var0) {
      try {
         ...
         var1.writeUTF(bt_1.b);
         var1.writeUTF(bt_1.d);
         var1.writeUTF(bt_1.ad);
         var1.writeByte(-81);
         return var3.toByteArray();
      } catch (IOException var2) {
         ((Throwable)var2).printStackTrace();
