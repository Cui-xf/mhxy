...
public final class y_1 extends bk {
   ...
   public final void d() {
      if (this.m != null) {
         this.n = super.f + (super.h - GlobalConfig.font2.stringWidth(this.m)) / 2;
         this.o = super.g + 5;
      }
   ...
   public final void a(Graphics var1) {
      ...
      if (this.m != null) {
         LoadingPage.drawString(var1, (String)this.m, (int)this.n, this.o + (a.c - GlobalConfig.font2_h) / 2, 0, this.l, 0);
      }
