...
public final class TextPanel extends BaseUi {
    ...
    public final void onClick(int var1) {
        if (this.fuWenBen) {
            if (this.fwbText != null && this.fwbText.length() != 0) {
                this.fwbRender = new FWBRender(this.fwbText, (short) (this.textW - 8 - MainCanvas.C.b));
            ...
            if (this.puTongText != null && this.puTongText.length() != 0) {
                this.huanHangWenBen = LoadingPage.parseText(this.puTongText, this.font, this.textW - 8 - MainCanvas.C.b, this.zhiBiaoFu);
    ...
    public void draw(Graphics graphics) {
        ...
        if (!this.fuWenBen && this.huanHangWenBen != null) {
            for (int var3 = this.a; var3 < this.huanHangWenBen.length && var3 < this.a + this.pageLines; ++var3) {
                if (var3 == this.h && this.gaoLiang) {
                    ...
                    if (this.h >= this.pageLines) {
                        graphics.fillRect(this.textX + 4, this.textY + 4 + (this.pageLines - 1) * this.lineH, this.textW - MainCanvas.C.b - 8, this.lineH);
                    } else {
                        graphics.fillRect(this.textX + 4, this.textY + 4 + this.h * this.lineH, this.textW - MainCanvas.C.b - 8, this.lineH);
                    }
                }
            ...
            if (this.gunDongH > 0) {
                LoadingPage.draw(graphics, this.textX + this.textW - 2 - MainCanvas.C.b, this.textY + 3, this.textH - 5, this.gunDongH, this.a, this.lines, this.pageLines);
                this.setGundongQuYu(this.textX + this.textW - 2 - MainCanvas.C.b, this.textY + 3, this.textX + this.textW - 2 - MainCanvas.C.b, this.textY + 3 + this.textH - 5 - MainCanvas.D.c, MainCanvas.D.b, MainCanvas.D.c);
            }
