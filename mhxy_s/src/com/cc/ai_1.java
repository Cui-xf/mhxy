...
public final class ai_1 {
   ...
   public static int a(bc_1 var0, long var1) {
   ...
   public final void a(Graphics var1, bx var2, int[] var3, int var4, int var5, int var6, int var7, int var8) {
      if (var2 != null && var2.a != null) {
         switch (var2.a.o) {
            case 0:
               this.a(var1, (bf_1)var2.a, var3, var2.a(), var4, var5, var6, var7, 0, var2.g);
               return;
            case 2:
               this.a(var1, (bc_1)((bc_1)var2.a), var3, var4, var5, var6, var7, 0, var8);
         }
      }
      ...
      if (var2 != null && var2.a != null) {
         switch (var2.a.o) {
            case 0:
               var6 += var2.e;
               var7 += var2.f;
               this.a(var1, (bf_1)var2.a, var3, var2.a(), var4, var5, var6, var7, 20, var2.g);
               return;
            case 2:
               var6 += var2.e;
               var7 += var2.f;
               this.a(var1, (bc_1)((bc_1)var2.a), var3, var4, var5, var6, var7, 20, var9);
         }
      }

   }

   public final void a(Graphics var1, bf_1 var2, int[] var3, aj var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      var7 -= var5;
      var8 -= var6;
      if (var2 != null && var2.a != null) {
   ...
   public final void a(Graphics var1, bf_1 var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      if (var2 != null && var2.d != null && var4 >= 0 && var4 < var2.d.length) {
         this.a(var1, var2, (int[])null, var2.d[var4], 0, 0, var7, var8, 0, var10);
      }
   }

   public final void a(Graphics var1, bc_1 var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9) {
   ...
   private void a(Graphics var1, aw var2, int var3, int var4, int var5, boolean var6) {
      ...
      if (var2.l != null) {
         for(int var10 = 0; var10 < var2.l.length; ++var10) {
            if (var2.l[var10] != null && var2.l[var10].a != null && (var2.l[var10].a.o != 2 || ((bc_1)var2.l[var10].a).k == null || ((bc_1)var2.l[var10].a).k.length <= 1)) {
   ...
   public final void a(bx var1, int[] var2) {
      if (var1.a != null) {
         switch (var1.a.o) {
            case 0:
               bf_1 var10000 = (bf_1)var1.a;
               int[] var10001 = this.g;
               aj var5 = ((bf_1)var1.a).a(var1.d);
               int[] var4 = var10001;
               bf_1 var3 = var10000;
               if (var10000 != null) {
                  if (var5 == null) {
   ...
   private static void a(bf_1 var0, int[] var1, aj var2) {
      if (var0 != null) {
         if (var2 == null) {
            var1[0] = 0;
            var1[1] = 0;
   ...
   public static void a(bc_1 var0, int[] var1) {
      if (var0 != null) {
         var1[0] = var0.g();
         var1[1] = var0.h();
      }
