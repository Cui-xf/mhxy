...
public final class u extends bk {
   ...
   public final int a(int var1, int var2) {
      if (((bk)this).b(var1, var2)) {
         if (this.d != null && var1 > super.f && var1 < super.f + GlobalConfig.font2.stringWidth(this.d) + 5 && var2 > super.g && var2 < super.g + super.i) {
            return 268435456;
         }
         ...
         if (this.j != null && var1 > super.f + super.h - GlobalConfig.font2.stringWidth(this.j) - 5 && var1 < super.f + super.h && var2 > super.g && var2 < super.g + super.i) {
            return 536870912;
         }
      }
   ...
   public final void a(Graphics var1) {
      ...
      if (this.d != null) {
         ...
         var1.drawString(this.d, super.f + 3, super.g + (super.i - GlobalConfig.font2_h) / 2, 20);
      }

      if (this.e != null) {
         var1.setColor(this.b);
         var1.drawString(this.e, super.f + super.h / 2, super.g + (super.i - GlobalConfig.font2_h) / 2, 17);
      }

      if (this.j != null) {
         var1.setColor(this.c);
         var1.drawString(this.j, super.f + super.h - 3, super.g + (super.i - GlobalConfig.font2_h) / 2, 24);
      }
