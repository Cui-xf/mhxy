...
public final class bt_1 {
   ...
   public static String a(StringBuffer var0, int var1) {
      ...
      StringBuffer var2;
      (var2 = new StringBuffer()).append(oz[var1]);
      var2.append("（");
      t_1.a(var0, oH[var1]);
   ...
   public static void M(DataInputStream var0) throws IOException {
      ...
      if (var1 > 0 && t_1.a != 0) {
         ...
         for(byte var9 = 0; var9 < var1; ++var9) {
            ...
            t_1.a("ServerIdPrix|" + hA[var9] + "|" + hD[var9]);
         }
      }
      ...
      if ((var1 = var0.readByte()) <= 0) {
         ...
         for(int var7 = 0; var7 < var1; ++var7) {
            ...
            if (!var8.equals("MONEY")) {
               ...
               t_1.a("lottery pos is " + var4);
            } else {
               t_1.a("lottery is money");
            }
         }
