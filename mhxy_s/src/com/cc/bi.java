...
public final class bi extends bk {
   ...
   public final void a() {
      this.a = this.b = 0;
      if (this.m != null) {
         this.n = d_1.a(this.m, super.h - 6, GlobalConfig.font2, '\t');
      }
      ...
      if (this.d > this.c) {
         this.n = d_1.a(this.m, super.h - 6 - 12, GlobalConfig.font2, '\t');
   ...
   public final void a(Graphics var1) {
      ...
      if (this.b > 0) {
         var1.setClip(super.f, super.g, super.h, super.i);
         LoadingPage.draw(var1, super.f + super.h - 2 - MainCanvas.C.b, super.g + 4, super.i - 6, this.b, this.a, this.l * this.d, super.i - 6);
      }
