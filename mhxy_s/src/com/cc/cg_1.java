...
public final class cg_1 {
   ...
   public final int a(int var1, int var2) {
      if (this.e.sceneSubState == 1) {
         ...
         int var3 = 0;
         if ((var3 = this.f.mixedUi.hintCheck(var1, var2)) <= 0) {
            var3 = this.H.hintCheck(var1, var2);
         }

         if (var3 <= 0) {
            var3 = this.I.hintCheck(var1, var2);
         }
   ...
   public final void b() {
      ...
      this.J = new int[2][4];
      this.H = new TextPanel();
      this.I = new TextPanel();
      ...
      this.e.lastSceneModeId = this.e.currentSceneModeId = 131;
   }

   public final void b(int var1) {
      if (F == 1) {
         F = 0;
         this.f.showTips("宠物星级继承成功");
         var1 = 0;
      ...
      if (this.e.sceneSubState == 0) {
         if (this.f.mixedUi != null) {
            this.f.mixedUi.onClick(var1);
            this.H.onClick(var1);
            this.I.onClick(var1);
         }
         ...
         if (var1 != 268435456 && var1 != 1073741824) {
            ...
            if (this.K == 1) {
               if (a != -1) {
                  ...
                  this.f.showTips("您没有符合要求的副宠");
                  return;
               }

               this.f.showTips("请先放入主宠");
               return;
            }
         }
