...
public final class RunnableC0066a extends Canvas implements Runnable, CommandListener {
    ...
    private void m1424w() throws Throwable {
        ...
        this.f2197bp = (int[][]) Array.newInstance((Class<?>) Integer.TYPE, 8, 5);
    ...
    public final void m1440b(int i) throws Throwable {
        m1424w();
        this.f2162bC = (int[][]) Array.newInstance((Class<?>) Integer.TYPE, 6, 4);
        C0055ca.f1892l = 0;
        C0055ca.f1888h = 0;
        C0055ca.f1895o = 0;
        this.f2207c = (short) 0;
    ...
    /* renamed from: j */
    public final void m1456j() throws IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        DataOutputStream dataOutputStream = new DataOutputStream(byteArrayOutputStream);
