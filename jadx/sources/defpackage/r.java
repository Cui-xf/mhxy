                ...
                if (this.b == 0) {
                    if (this.a == 0) {
                        ...
                        if (this.c == -1) {
                            ...
                            ca.a((this.j.aq.c - (ao.x.b * 3)) - 21, this.j.aq.b + 49, new String[]{"取出"}, false);
                            this.i.l = (short) 1;
                        }
                    }
                } else if (this.b == 1) {
                    if (d(this.a) != -1) {
                        ca.a(((((this.j.aq.c - 10) - ao.x.b) - ((this.a + ((1 - this.a) * 2)) * (ao.x.b + 10))) - (ca.q / 2)) + 9, this.j.aq.b + ao.x.c + 69, new String[]{"取出"}, false);
                        this.i.l = (short) 1;
            ...
            if (i == 268435456 || i == 1073741824) {
                if (ca.o == 0) {
                    if (this.b == 1) {
                        ...
                        byte[] bArrA2 = this.a == 0 ? bz.a((short) 4262, this.c, this.d, (byte) 3, this.e, this.f, -1, (byte) -1, bt.ad) : this.a == 1 ? bz.a((short) 4262, this.c, this.d, (byte) 5, this.e, this.f, -1, (byte) -1, bt.ad) : null;
                        if (bArrA2 != null) {
    ...
    public final void a(Graphics graphics) {
        ...
        if (this.p != null && this.p.length > 0) {
            for (int i5 = 0; i5 < this.p.length; i5++) {
                ...
                if (bfVarB3 != null) {
                    graphics.drawImage(bfVarB3.a, this.g[this.f[i5] + 2][0], this.g[this.f[i5] + 2][1], 20);
                }
            }
        }
        ...
        if (this.i.l != 0) {
            ...
            if (this.b == 0 && this.a == 1) {
                ca.b(graphics, this.u, ((((this.j.aq.c - 10) - ao.x.b) - ((ao.x.b + 10) * 2)) - 6) - t.i.stringWidth("装备孔"), ao.x.c + this.j.aq.b + 32 + 8, t.c - 5, 1);
            } else if (this.b == 1) {
                ca.b(graphics, this.u, this.j.aq.c - ((ao.x.b + 10) * 3), (ao.x.c << 1) + this.j.aq.b + 32 + 8 + 10, t.c - 5, 1);
            } else {
                ca.b(graphics, this.u, this.j.aq.a + 5 + 2, ao.x.c + this.j.aq.b + 32 + 8, t.c - 5, 1);
            }
        }
    }
