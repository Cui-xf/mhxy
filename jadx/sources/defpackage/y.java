...
/* loaded from: java版梦回西游3区251011.jar:y.class */
public final class y extends bk {
    ...
    public final void d() {
        ...
        if (this.q != -1) {
            af afVar = (af) this.u.elementAt(this.q);
            afVar.a(i2, iE, this.h - 10, 25);
            iE += afVar.e() - 3;
            iE2 -= afVar.e() - 3;
        }
        if (this.t != -1) {
        ...
        if (this.r != -1 && this.s != -1) {
            ...
            biVar.a(i2, iE + ((iE2 << 2) / 7), this.h - 10, iE3);
            biVar.a(this.q != -1);
    ...
    public final void a(Graphics graphics) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            graphics.drawImage(a.a, this.f + (i2 * a.b), this.g + 5, 20);
        }
        graphics.setClip(this.f, this.g, this.h, this.i);
        graphics.drawImage(b.a, ((this.f + this.h) - b.b) - 5, this.g + 6, 20);
        if (this.m != null) {
            ca.a(graphics, this.m, this.n, this.o + ((a.c - t.j) / 2), 0, this.l, 0);
        }
