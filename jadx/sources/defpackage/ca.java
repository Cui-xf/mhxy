...
/* loaded from: java版梦回西游3区251011.jar:ca.class */
public final class ca {
    ...
    public static void a(az azVar, bw bwVar, String[] strArr, String[] strArr2, boolean z2) {
        ...
        if (bwVar != null && bwVar.a() != 0) {
            int i2 = (((t.c - 26) - sD) - (length * t.j)) / t.j;
            if (z2) {
                int iA = bwVar.a();
                int[] iArr = new int[2];
                if (iA <= i2) {
    ...
    public static void a(Graphics graphics, int i2, int i3, int i4, int i5, bw bwVar, String[] strArr, String[] strArr2) {
        ...
        while (i7 < strArr.length) {
            a(F != null ? F[i7] : null, 10, ((i3 + i5) - 9) - ((strArr.length - i7) * t.j), t.i.stringWidth(strArr[i7]), t.j);
            a(graphics, strArr[i7], F[i7][0], F[i7][1], 20, g == i7 ? 16711680 : 16777215, 0);
            i7++;
        }
    }
                ...
                if (H != null) {
                    if (H.length == 1) {
                        ...
                        for (int i2 = 0; i2 < H.length; i2++) {
                            a(graphics, H[i2], (t.b - t.i.stringWidth(H[i2])) / 2, ((t.c - I) / 2) + 10 + (i2 * t.j), 20, 16777215, 0);
                        }
                    }
                }
                if (J == null) {
    ...
    public static void a(Graphics graphics, Image image, short s2, int i2, int i3, int i4, int i5) {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            graphics.drawImage(image, i2 + (i7 * s2), i3, 20);
        }
        graphics.setClip(0, 0, t.b, t.c);
    }
    ...
    public static void a(Graphics graphics, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (i5 > 0) {
            i9 = i3 + a.C.c + (((((i4 - a.C.c) - a.D.c) - i5) * i6) / (i7 - i8));
        } else if (i5 <= 0) {
            i9 = i3 + a.C.c;
            i5 = (i4 - a.C.c) - a.D.c;
        }
        graphics.setColor(11267556);
        graphics.fillRect(i2, i9, a.C.b - 1, i5 - 1);
        graphics.setColor(5555146);
        graphics.fillRect(i2 + 2, i9 + 2, 8, i5 - 4);
        graphics.setColor(1801628);
        graphics.fillRect(i2 + 3, i9 + 3, 6, i5 - 6);
        graphics.setColor(1464956);
        graphics.fillRect(i2 + 6, i9 + 4, 2, i5 - 8);
        graphics.setColor(150092);
        graphics.drawRect(i2, i9, a.C.b - 1, i5 - 1);
    }
    ...
    public static void b(Graphics graphics, int i2, int i3, int i4, int i5, int i6) {
        ...
        for (int i8 = 0; i8 < iAbs; i8++) {
            graphics.drawLine(i3 + (i8 * i7), i4 - i8, i3 + (i8 * i7), i4 + i8);
        }
    }
    ...
    public static void b(Graphics graphics) {
        graphics.setClip(0, 0, t.b, t.c);
        a(graphics, 1808583, 95, M, N - (4 + t.j), O, 8 + t.j + 18);
    ...
    private static String c(String str, Font font, int i2) {
        ...
        if (R != S) {
            ...
            if (iLastIndexOf - T >= 1) {
                try {
                    if (Integer.parseInt(str.substring(T + 1, U)) <= 41) {
                        strSubstring = str.substring(0, str.lastIndexOf(60));
                    }
    ...
    public static void b(Graphics graphics, String str, int i2, int i3, int i4, int i5) {
        ...
        if (l >= 15) {
            ...
            Z = i2 + X <= t.f + t.d ? i2 : i2 - X >= t.f ? i2 - X : t.f + ((t.d - X) / 2);
            aa = i3 + Y <= i4 ? i3 : i3 - Y >= t.g ? i3 - Y : t.g + ((t.e - Y) / 2);
            if (l == 15) {
                ...
                if (i5 == 1) {
                    ...
                    for (int i7 = 0; i7 < W.length; i7++) {
                        if (W[i7] != null) {
                            graphics.drawString(W[i7], Z + 4, aa + 4 + (i7 * t.j), 0);
                        }
                    }
                }
            }
    ...
    */
    public static void a(javax.microedition.lcdui.Graphics r9, java.lang.String r10, long r11, int r13, int r14, int r15) {
        /*
    ...
    */
    ...
    public static void a(Graphics graphics, String str, int i2, boolean z2) {
        ...
        if (z2 && a.X != null && a.Y != null && a.V != null && a.W != null) {
            graphics.drawImage(a.V.a, i4 + ((140 - a.V.b) / 2), i5 + 7 + t.j, 20);
            a(aj[0], i4 + ((140 - a.V.b) / 2), i5 + 7 + t.j, a.V.a.getWidth(), a.V.a.getHeight());
            graphics.drawImage(a.W.a, i4 + ((140 - a.V.b) / 2), i5 + 5 + (t.j << 1) + 14, 20);
            a(aj[1], i4 + ((140 - a.V.b) / 2), i5 + 5 + (t.j << 1) + 14, a.W.a.getWidth(), a.W.a.getHeight());
    ...
    public static void a(Graphics graphics, Image image) {
        ...
        graphics.drawString(new StringBuffer().append((100 * A) / 100).append("%").toString(), t.b / 2, an[1] + 10, 17);
    ...
    public static int f(int i2, int i3) {
        int iNextInt = i2 + (aq.nextInt() % (i3 - i2));
        int i4 = iNextInt < 0 ? -iNextInt : iNextInt;
        return i4 == 0 ? 1 : i4;
    }
    ...
    public static void f(Graphics graphics, int i2, int i3, int i4, int i5) {
        ...
        if (a.z != null) {
            graphics.drawImage(a.z.a, i2 - 4, (i3 + (i5 + 4)) - a.z.c, 20);
        }
        if (a.w != null) {
            graphics.drawImage(a.w.a, ((i2 + 4) + i4) - a.w.b, i3 - 4, 20);
        }
        if (a.x != null) {
            graphics.drawImage(a.x.a, ((i2 + 4) + i4) - a.x.b, (i3 + (i5 + 4)) - a.x.c, 20);
        }
    }
}
