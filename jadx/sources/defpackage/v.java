...
/* loaded from: java版梦回西游3区251011.jar:v.class */
public final class v {
    ...
    public final void b(Graphics graphics) {
        if (this.h.l == 0) {
            ...
            if (this.i.aq != null) {
                i = this.i.aq.a + 5;
                i2 = ((this.i.aq.b + this.i.aq.d) - ((2 * t.j) + 16)) - 6;
                ca.a(graphics, i, i2, this.i.aq.c - 11, (2 * t.j) + 16, 1);
                this.i.aq.a(graphics);
            }
            int i3 = 0;
            while (i3 < 2) {
                int i4 = 16777215;
                if (l != 0) {
                    int i5 = (this.d == 1 && l == 1) ? 8750469 : 16777215;
                    i4 = i5;
                    this.m[0] = l == 1 ? "同意(等待对方确认)" : "同意(对方已确认)";
                } else {
                    this.m[0] = "同意(点击申请结婚)";
                }
                ca.a(graphics, this.m[i3], i + 4, i2 + 5 + (i3 * (t.j + 5)), 20, this.d == i3 ? 16711680 : i4, 0);
                i3++;
            }
        }
    }
    ...
    public final void c(Graphics graphics) {
        if (this.h.l == 0) {
            ...
            while (i3 < 2) {
                int i4 = 16777215;
                if (e != 0) {
                    int i5 = (this.g == 1 && e == 1) ? 8750469 : 16777215;
                    i4 = i5;
                    this.n[0] = e == 1 ? "离婚(等待对方确认)" : "离婚(对方已确认)";
                } else {
                    this.n[0] = "离婚(点击申请离婚)";
                }
                ca.a(graphics, this.n[i3], i + 4, i2 + 5 + (i3 * (t.j + 5)), 20, this.g == i3 ? 16711680 : i4, 0);
                i3++;
            }
        }
    }
